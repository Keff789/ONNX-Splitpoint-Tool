...
"""Fast, hardware-free smoke checks for v60p smoke/warning/completeness rules."""
...
from .workflow.runner import _benchmark_stage_status_v60p, _campaign_stage_status_v60p
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="onnx-splitpoint-smoke-v60p", description="Run fast v60p smoke/warning/completeness checks without hardware.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    payload = {
        "schema": "onnx-splitpoint/v60p-smoke",
    ...
    print(f"v60p smoke: {'ok' if failed == 0 else 'FAILED'} ({passed} passed, {failed} failed)")
