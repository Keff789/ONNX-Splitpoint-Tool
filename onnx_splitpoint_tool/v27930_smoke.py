"""Hardware-independent release smoke for the v2.79.30 DeepX Full integration and terminal closure.
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27930_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27930_small_acceptance.sh" in
