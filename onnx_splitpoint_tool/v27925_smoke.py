"""Hardware-independent release smoke for the v2.79.25 DeepX GPU and quality follow-up.
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27925_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27925_small_acceptance.sh" in
