"""Hardware-independent release smoke for the v2.79.32 Native Full failure closure and explicit compiler precedence.
...
from .v27931_smoke import REQUIRED_FEATURES as V31_REQUIRED_FEATURES

REQUIRED_FEATURES = set(NEW_FEATURES) | V31_REQUIRED_FEATURES
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27932_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27932_small_acceptance.sh" in
