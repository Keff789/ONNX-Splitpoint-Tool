...
NEW_FEATURES = {'v282_selected_energy_attempt', 'v282_generic_variant_exclusions', 'v282_early_workspace', 'v282_product_runner_layout', 'v282_owned_dump_evidence', 'v282_quality_partial_status'}


from .v281_smoke import REQUIRED_FEATURES as PREVIOUS_REQUIRED_FEATURES
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v282_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v282_small_acceptance.sh" in
