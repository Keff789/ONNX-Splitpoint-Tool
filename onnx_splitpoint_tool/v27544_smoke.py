"""Hardware-independent release contract for ONNX Split-Point Tool 2.75.44."""
...
VERSION = "2.75.44"
BUILD_ID = "v2.75.44-runtime-validation-cohort-projection"
...
def main() -> int:
    ...
    result = {
        "schema": "onnx-splitpoint/v27544-smoke",
        "schema_version": 1,
