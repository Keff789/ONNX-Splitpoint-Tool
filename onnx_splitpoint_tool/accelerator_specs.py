...
_DEFAULT: Dict[str, List[Dict[str, Any]]] = {
    "accelerators": [
        ...
        {"id": "hailo_8l", "name": "Hailo-8L", "ram_limit_mb": 4096, "runtime_overhead_mb": 256, "notes": "Conservative placeholder; verify host/device memory budget.", "perf": {"tops_int8": 13, "gflops_fp16": 0, "efficiency_factor": 0.6}},
