"""Hardware-independent release smoke for the v2.79.23 native runtime, cache reuse and measurement fixes.
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27923_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27923_small_acceptance.sh" in
