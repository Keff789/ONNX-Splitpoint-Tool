"""Hardware-independent release smoke for the v2.79.22 persistent negative-evidence integration.

Behavioral persistence, recovery and negative-dispatch regressions are run by
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27922_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27922_small_acceptance.sh" in
