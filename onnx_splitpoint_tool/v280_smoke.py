"""Hardware-independent release smoke for the v2.80 Hailo reuse, compute environment and runtime cleanup.
...
NEW_FEATURES = {'v280_runtime_cleanup_truth', 'v280_build_reporting_truth', 'v280_artifact_reuse_boundary', 'v280_hailo8_compute_child_environment'}


from .v27934_smoke import REQUIRED_FEATURES as PREVIOUS_REQUIRED_FEATURES
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v280_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v280_small_acceptance.sh" in
