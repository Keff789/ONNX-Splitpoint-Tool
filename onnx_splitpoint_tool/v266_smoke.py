"""Hardware-independent release-contract smoke test for version 2.66."""
...
def main() -> int:
    ...
    checks = {
        ...
        # 2.66 made the strict diagnostic Final-fatal.  The compatibility
        # smoke also runs on later package identities, where 2.67 deliberately
        # supersedes that policy after freezing the command-marker primary.
        "final_probe_policy_compatible": (
            final_probe_blocks if __release__ == "2.66" else not final_probe_blocks
        ),
    ...
    result = {
        "schema": "onnx-splitpoint/v266-smoke",
        "schema_version": 1,
