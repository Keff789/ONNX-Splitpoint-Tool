"""Hardware-independent release smoke for the v2.79.24 targeted run repairs.
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27924_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27924_small_acceptance.sh" in
