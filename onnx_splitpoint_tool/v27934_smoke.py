"""Hardware-independent release smoke for the v2.79.34 family compiler context, productive Force OFF and private diagnostics.
...
NEW_FEATURES = {'v27934_hailo8_dependency_plan', 'v27934_private_build_diagnostic', 'v27934_family_compiler_context', 'v27934_productive_force_off'}


from .v27933_smoke import REQUIRED_FEATURES as V32_REQUIRED_FEATURES

REQUIRED_FEATURES = set(NEW_FEATURES) | V32_REQUIRED_FEATURES
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27934_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27934_small_acceptance.sh" in
