"""Hardware-independent release-contract smoke test for version 2.69e."""
...
from .v269d_smoke import REQUIRED_FEATURES as V269D_REQUIRED_FEATURES
from .workflow.artifacts import package_build_snapshot
from .workflow.runner import WORKFLOW_VERSION


REQUIRED_FEATURES = V269D_REQUIRED_FEATURES | {
...
def main() -> int:
    ...
    result = {
        "schema": "onnx-splitpoint/v269e-smoke",
        "schema_version": 1,
