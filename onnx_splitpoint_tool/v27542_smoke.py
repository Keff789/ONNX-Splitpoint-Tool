"""Hardware-independent release contract for ONNX Split-Point Tool 2.75.42."""
...
VERSION = "2.75.42"
BUILD_ID = "v2.75.42-real-evidence-and-quality-companion-repair"
...
REQUIRED_FEATURES = {
    ...
    # The scientific v2.75.41 calibration-size experiment is retained.
...
def main() -> int:
    ...
    result = {
        "schema": "onnx-splitpoint/v27542-smoke",
        "schema_version": 1,
