"""Hardware-independent release-contract smoke test for version 2.65."""
...
def main() -> int:
    ...
    result = {
        "schema": "onnx-splitpoint/v265-smoke",
        "schema_version": 1,
