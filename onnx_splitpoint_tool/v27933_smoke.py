"""Hardware-independent release smoke for the v2.79.33 typed configuration, Force consent and Generic Full scope binding.
...
from .v27932_smoke import REQUIRED_FEATURES as V32_REQUIRED_FEATURES
...
def main() -> int:
    ...
    checks = {
        "version": __version__ == __release__ == VERSION == "2.79.33",
        ...
        "current_aliases": (
            "from .v27933_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27933_small_acceptance.sh" in
