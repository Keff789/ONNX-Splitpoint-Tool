"""Hardware-independent release smoke for version 2.79.4."""
...
VERSION = "2.79.4"
LINEAGE = "v2.79"
BUILD_ID = "v2.79.4-native-productized-three-stage-release-consistency"
NEW_FEATURES = {
...
def _runtime_checks(root: Path) -> dict[str, bool]:
    ...
    with tempfile.TemporaryDirectory(prefix="osp-v2793-smoke-") as temporary:
    ...
    return {
        ...
        "updater": (
            "--expected-version 2.79.4" in updater
...
def main() -> int:
    ...
    checks = {
        ...
        "productized_three_stage": all((root / name).is_file() for name in (
