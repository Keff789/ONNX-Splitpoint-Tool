"""Hardware-independent release smoke for version 2.79.3."""
...
VERSION = "2.79.3"
LINEAGE = "v2.79"
BUILD_ID = "v2.79.3-native-productized-three-stage-endpoint-evidence"
NEW_FEATURES = {
...
def _runtime_checks(root: Path) -> dict[str, bool]:
    ...
    return {
        ...
        "updater": (
            "--expected-version 2.79.3" in updater
