"""Hardware-independent release smoke for the v2.79.27 DeepX output probe and result fixes.
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27927_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27927_small_acceptance.sh" in
