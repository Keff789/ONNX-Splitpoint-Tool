"""Hardware-independent release smoke for the v2.79.26 DeepX Full and diagnostics fixes.
...
def main() -> int:
    ...
    checks = {
        ...
        "current_aliases": (
            "from .v27926_smoke import" in
            (root / "onnx_splitpoint_tool/v279_smoke.py").read_text(encoding="utf-8")
            and all("run_v27926_small_acceptance.sh" in
