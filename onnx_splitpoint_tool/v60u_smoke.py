...
"""Hardware-free regression smoke for v60u native-contract diagnostics."""
...
def run_smoke() -> dict[str, Any]:
    ...
    return {
        "schema": "onnx-splitpoint/v60u-smoke",
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="onnx-splitpoint-smoke-v60u")
    ...
    print(f"v60u smoke: {'ok' if payload['status'] == 'ok' else 'FAILED'} ({payload['passed']} passed, {payload['failed']} failed)")
