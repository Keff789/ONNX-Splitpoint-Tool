...
SCRIPT = ROOT / "scripts" / "verify_v2796_yolov7_claim_gate_32.py"
SPEC = importlib.util.spec_from_file_location("v2796_yolov7_claim_gate", SCRIPT)
...
def _fixture(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> dict[str, Any]:
    ...
    run_id = "v2796_yolov7_claim_gate_fixture"
    result = {
        "ok": True,
