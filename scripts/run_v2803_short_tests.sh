...
TEST_OUT="$(mktemp -d "$HOME/Downloads/v2803_short_tests_XXXXXXXX")"
...
"$TEST_PY" -B -c 'import onnxruntime as ort; ort.disable_telemetry_events(); from onnx_splitpoint_tool.v2803_smoke import main; raise SystemExit(main())' \
