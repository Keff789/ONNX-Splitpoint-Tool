#!/usr/bin/env python3
"""Fail-closed verifier for the v2.79.7 YOLOv7 ``claim_gate_32``.
...
def verify_claim_gate(
    *, result_json: Path, evidence_root: Path, source_root: Path,
    ...
    _need(product.get("source_snapshot_prefix") == "ONNX-Splitpoint-Tool_v2.79.7", "source_snapshot_prefix")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    try:
        ...
        print("V2797_YOLOV7_CLAIM_GATE=PASS")
        return 0
