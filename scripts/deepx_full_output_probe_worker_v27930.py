...
def run_probe(request: dict, work: Path) -> dict:
    ...
    spec = importlib.util.spec_from_file_location("deepx_probe_suite_v27930", template)
    ...
    if not callable(function):
        raise ValueError("v27930_template_probe_api_missing")
    ...
    result["probe_source"] = {
        "probe_fix": "v27930", "staging_mode": STAGING_MODE,
