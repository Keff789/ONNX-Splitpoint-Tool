...
def run_probe(request: dict, work: Path) -> dict:
    ...
    spec = importlib.util.spec_from_file_location("deepx_probe_suite_v27928", template)
    ...
    if not callable(function):
        raise ValueError("v27928_template_probe_api_missing")
    ...
    result["probe_source"] = {
        "probe_fix": "v27928", "staging_mode": STAGING_MODE,
