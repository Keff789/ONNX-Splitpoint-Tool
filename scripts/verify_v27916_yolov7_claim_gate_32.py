#!/usr/bin/env python3
"""Fail-closed v2.79.16 verifier for retained YOLOv7 claim-gate evidence.
...
that implementation byte-for-byte, then applies only the v2.79.16 release
identity and the exact current snapshot-member identities.  The complete
v2.79.16 source manifest, the retained source snapshot, the prior receipt and
...
VERIFIER_FILENAME = "verify_v27916_yolov7_claim_gate_32.py"
...
def _load_frozen_base() -> Any:
    ...
    spec = importlib.util.spec_from_file_location(
        "_onnx_splitpoint_v27916_yolov7_claim_gate_base", path
    )
...
_origin["current_snapshot_member_sha256"] = {
    "onnx_splitpoint_tool/__init__.py": (
        "cfff4ea0bb5bcaf76c9cfbcc65786c9fbc957cb507cea935b0238d8a50ab9baa"
    ),
    "onnx_splitpoint_tool/release_identity.py": (
        "e4a989fd54996a5a148b5d95368baeaff380676c61887655b360e3e0543c0156"
    ),
